...
Oscilloscope Siglent SDS1052DL -captured SMBus data
Atmega328 comm with BQ20Z80-DBT via SMBUS
This script takes the csv file generated by the oscilloscope as argument and outputs the logic data in binary,decimal and hex formats.
Ouput -> S denotes a Start/Stop event for SMBUS comm.
'''
import csv
import sys
