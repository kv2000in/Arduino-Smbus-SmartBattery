...
//delay(100);
//i2c_smbus_manf_access(BATT_SMBUS_MANUFACTURE_ACCESS,BATT_SMBUS_MANUFACTURE_LED_OFF); // ABle to toggle LEDs
//delay(100);
//i2c_smbus_PF_Clear ();
//i2c_smbus_manf_access(BATT_SMBUS_MANUFACTURE_ACCESS,BATT_SMBUS_MANUFACTURE_RESET);
//i2c_smbus_manf_access(BATT_SMBUS_MANUFACTURE_ACCESS,BATT_SMBUS_MANUFACTURE_MANUF_STATUS);
}
...
//    Serial.println(fetchWord(BATTERY_STATUS),BIN); // 01001000 11000000
...
//    
//    Serial.print("Perm Failure Status: " );
//    Serial.println(fetchWord(PERM_FAILURE_STATUS));
      
//      Serial.print("Reset Data: " ); //00010111 00000000
//      Serial.println(fetchWord(RESET_DATA)); //This read-word function returns the number of partial resets (low byte) and full resets (high byte) the device has experienced.
//
//      Serial.print("WDR Reset Data: " );
//      Serial.println(fetchWord(WD_RESET_DATA));//This read-word function returns the number of watchdog resets the device has experienced.
...
//    Serial.println(fetchWord(EXTENDED_SBS_OP_STATUS)); //HIGH BYTE:10000000 Low BYTE: 01000011 when Battery plugged in. high byte 00000000 Low byte 01000011 When Battery removed.
//    Serial.println(".");

//    Serial.print("AFE Data: ");
//    length_read = i2c_smbus_read_block(EXTENDED_SBS_AFE_DATA, i2cBuffer, bufferLen);
//    Serial.write(i2cBuffer, length_read);
//    Serial.println("");
//
//      Serial.print("Manufacturer Data: ");
